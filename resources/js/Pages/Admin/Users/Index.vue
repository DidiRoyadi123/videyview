    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-3xl font-black text-white italic uppercase tracking-tighter">Pengguna Premium</h2>
                <div class="bg-indigo-500/10 px-4 py-1 rounded-full border border-indigo-500/20">
                    <span class="text-[10px] font-black uppercase text-indigo-400 tracking-widest">{{ users.total }} Pengguna Terverifikasi</span>
                </div>
            </div>
        </template>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
                ...
                <div class="glass-dark p-8 rounded-[2rem] border border-white/5 relative overflow-hidden group">
                    ...
                    <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
                        <div>
                            <InputLabel for="name" value="Nama Lengkap" class="!text-slate-500 !text-[10px] !font-black !uppercase !tracking-widest mb-1" />
                        ...
                        <div>
                            <InputLabel for="email" value="Alamat Email" class="!text-slate-500 !text-[10px] !font-black !uppercase !tracking-widest mb-1" />
                        ...
                        <div>
                            <InputLabel for="password" value="Kata Sandi" class="!text-slate-500 !text-[10px] !font-black !uppercase !tracking-widest mb-1" />
                        ...
                        <div>
                            <InputLabel for="duration_days" value="Hari (Akses)" class="!text-slate-500 !text-[10px] !font-black !uppercase !tracking-widest mb-1" />
                        ...
                        <div class="lg:col-span-4 flex justify-end">
                            <PrimaryButton :disabled="form.processing" class="btn-premium !px-12">BUAT AKUN PREMIUM</PrimaryButton>
                        </div>
                    </form>
                </div>
                        ...
                        <table class="w-full text-left">
                            <thead>
                                <tr class="text-[10px] font-black uppercase text-slate-500 tracking-widest border-b border-white/5 bg-white/5">
                                    <th class="py-5 px-8">Profil Anggota</th>
                                    <th class="py-5 px-8">Info Kontak</th>
                                    <th class="py-5 px-8">Tanggal Kedaluwarsa</th>
                                    <th class="py-5 px-8">Status Tingkatan</th>
                                ...
                                <tr v-for="user in users.data" :key="user.id" class="group hover:bg-white/5 transition duration-300">
                                    ...
                                    <td class="py-5 px-8">
                                        <div class="inline-flex items-center gap-2 group/contact">
                                            <span class="text-xs font-bold text-slate-300">{{ user.whatsapp_telegram || 'Tidak disediakan' }}</span>
                                            <button v-if="user.whatsapp_telegram" @click="navigator.clipboard.writeText(user.whatsapp_telegram); toastSuccess('Kontak disalin!')" class="opacity-0 group-hover/contact:opacity-100 transition-opacity p-1 text-slate-500 hover:text-indigo-400">
                                    ...
                                    <td class="py-5 px-8">
                                        ...
                                        <div class="text-[9px] text-slate-500 font-black uppercase tracking-widest mt-0.5">Penagihan otomatis</div>
                                    </td>
                                    <td class="py-5 px-8">
                                    ...
                                    <td class="py-5 px-8 text-right">
                                        <div class="flex justify-end gap-3 items-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <div class="flex flex-col gap-2 bg-white/5 rounded-2xl border border-white/10 p-3 w-48 text-left">
                                                <div>
                                                    <label class="text-[9px] font-black uppercase text-slate-500 tracking-widest block mb-1 ms-1">Atur Ulang Kata Sandi</label>
                                                ...
                                                <div>
                                                    <label class="text-[9px] font-black uppercase text-slate-500 tracking-widest block mb-1 ms-1">Berikan Hari Premium</label>
                                                    <div class="flex gap-1">
                                                        <input 
                                                            type="number" 
